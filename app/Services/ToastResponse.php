...
class ToastResponse extends JsonResponse
{
    ...
    public function setTitle($title): ToastResponse
    {
    ...
    public function withData($data): ToastResponse
    {
    ...
    public function setType($type): ToastResponse
    {
        $original = $this->original;
    ...
    public function setOption($option): ToastResponse
    {
        $original = $this->original;
