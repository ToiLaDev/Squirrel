                                ...
                                @isset($setting['browser'])
                                    <div class="form-check d-flex justify-content-center">
                                        <input
                                            class="form-check-input"
                                            type="checkbox"
                                            name="{{$setting['browser']['key']}}"
                                            @if($setting['browser']['value'])
                                            checked
                                            @endif
                                        />
                                    </div>
                                ...
                                @isset($setting['app'])
                                    <div class="form-check d-flex justify-content-center">
                                        <input
                                            class="form-check-input"
                                            type="checkbox"
                                            name="{{$setting['app']['key']}}"
                                            @if($setting['app']['value'])
                                            checked
                                            @endif
                                        />
                                    </div>
                                ...
                                @isset($setting['sms'])
                                    <div class="form-check d-flex justify-content-center">
                                        <input
                                            class="form-check-input"
                                            type="checkbox"
                                            name="{{$setting['sms']['key']}}"
                                            @if($setting['sms']['value'])
                                            checked
                                            @endif
                                        />
                                    </div>
